 ...
 * against a real hanzo-vm VM.
 *
 * Prerequisites:
 *   1. cargo build -p hanzo-vm -p vm-guest --target aarch64-unknown-linux-musl --release
 *   2. ./scripts/prepare-rootfs.sh
 *   3. codesign --entitlements vm.entitlements --force -s - target/debug/hanzo-vm
 *   4. hanzo-vm init
 *
